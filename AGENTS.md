...
is read automatically by AI coding agents that respect it. It supplies
project-specific context so an agent contributing to mumei flags the
...
When reviewing or contributing to a mumei PR, apply the focus areas below.
