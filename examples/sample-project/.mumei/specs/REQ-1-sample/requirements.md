...
- REQ-1.1 [CONFIRMED] WHEN a developer opens `examples/sample-project/`, the system SHALL provide a complete and parseable `.mumei/specs/REQ-1-sample/` directory mirroring the layout produced by a real `/mumei:compose` invocation.
