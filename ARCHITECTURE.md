...
│   ├── pre-edit-guard.sh   # P1 / P2 / P3 / I1 / I2 / W1 / M1 / S1 / G1 / E1 / E2
...
| E2   | implement    | PreToolUse(Edit)         | Editing a production file (both vehicles) before every `## Acceptance Test` path exists and is non-empty (test-first); editing a pinned test path itself is allowed with an advisory warning | `hooks/pre-edit-guard.sh`     |
